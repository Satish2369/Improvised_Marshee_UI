      ...
      <div className="flex flex-col items-center mt-2 ml-[6vw]">
        <div className="flex flex-col px-6 pt-2 w-full">
          ...
          <div className="flex   justify-start items-center mt-4 gap-6">
            <div className="flex items-center justify-center gap-3 mt-6 bg-white w-[440px] py-3 rounded-xl border border-gray-300  px-3">
                ...
                {categories.map((cat) => {
                  ...
                  return (
                    <div
                      ...
                      className={`flex items-center gap-2 px-2 py-2 rounded-full border transition duration-200 ${
                        isActive
                          ? "bg-yellow-300 text-white "
                          : "text-yellow-300 border-blue-500 hover:bg-yellow-300 hover:text-white"
                      }`}
                    >
                      <div
                        className={`${
            ...
            <div className="flex items-center gap-3 mt-6 bg-white w-[330px]  rounded-xl border py-2 border-gray-300  px-3">
              <div className="text-black text-[16px] ml-[0.5vw]">
                Show results for
              </div>
              <div className="bg-yellow-300 px-4 py-2 rounded-md">Max</div>
              <div className="bg-black text-white px-6 rounded-md py-2">
                Loki
              </div>
            </div>
          </div>
